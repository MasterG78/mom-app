-- Drop the old version that used numeric for quantity, rate, and amount
DROP FUNCTION IF EXISTS public.upsert_invoice_line_item(text, text, text, numeric, numeric, numeric, text);

-- Create new robust version
